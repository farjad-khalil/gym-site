...
const Footer = () => {
  ...
  {/* Footer Content */}
  <div className="px-10 sm:px-16 py-12 bg-white max-w-[1440px] mx-auto ">
    <div className="max-w-[1440px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
      ...
      {/* Footer Links */}
      <div className="sm:col-span-2 lg:col-span-4 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6">
